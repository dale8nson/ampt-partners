    ...
    <section className="bg-gray-900" >
      <div className="container px-6 py-8 mx-auto">
        ...
        <div className="w-full max-w-xs text-center">
          ...
          <div className="w-full max-w-xs text-center">
            <motion.img {...scrollProps} className="object-cover w-full h-48 mx-auto rounded-lg object-top" src="/Clarence_Darrow.jpg" alt="avatar" />
            <div className="mt-2">
          ...
          <div className="w-full max-w-xs text-center">
            <motion.img {...scrollProps} className="object-cover object-right w-full h-48 mx-auto rounded-lg" src="/ee673e8472521baf4c69ef50d3c2077c_1280x720.jpg" alt="avatar" />
            <div className="mt-2">
          ...
          <div className="w-full max-w-xs text-center">
            <motion.img {...scrollProps} className="object-cover object-center w-full h-48 mx-auto rounded-lg" src="/96987637.jpg.0.jpg" alt="avatar" />
            <div className="mt-2">
          ...
          <div className="w-full max-w-xs text-center">
            <motion.img {...scrollProps} className="object-cover object-center w-full h-48 mx-auto rounded-lg" src="/qfadd70b8-d6b2-4534-9544-f598d2066f4a_perry-ma_jvkzCgl.jpg" alt="avatar" />
            <div className="mt-2">
          ...
          <div className="w-full max-w-xs text-center">
            <motion.img {...scrollProps} className="object-cover object-top w-full h-48 mx-auto rounded-lg" src="/1e83cf51c8012a56c3dc145dbd611c5f.jpg" alt="avatar" />
            <div className="mt-2">
