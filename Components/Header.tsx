...
export const Header = () => {
  return (
    <section className="relative flex-col h-[60vh] lg:h-[80vh] px-0 overflow-hidden w-full mx-0 z-[-10] justify-center align-middle">
      <div className='h-[60vh] lg:h-[80vh] w-full overflow-hidden bg-[url("/pexels-finn-whelen-6227601-6182776.jpg")] lg:bg-gray-900 bg-[size:150%] bg-fixed lg:bg-cover bg-center'>
