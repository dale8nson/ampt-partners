...
export const Header = () => {
   return (
   <section className="relative flex-col h-[50vh] lg:h-[80vh] px-0 overflow-hidden w-full mx-0 z-[-10] justify-center align-middle">
      <div className='h-[80vh] w-full overflow-hidden'>
        <video src='https://kknrt8efjhtrayxq.public.blob.vercel-storage.com/17920530-uhd_3840_2160_30fps-bsWTPlCQyMX0XLUUSVag2Li2rqe0rW.webm' className="fixed -z-50 px-0 mx-auto w-full h-[50vh] lg:h-[80vh] object-cover content-center" autoPlay loop muted />
